...
import { carports, carportsIntro } from "@/data/solaris";

export const metadata: Metadata = {
  title: "Carports",
  description: carportsIntro.subtitle,
};
...
export default function CarportsPage() {
  return (
    <>
      <PageHeader
        eyebrow="Produkte"
        title={carportsIntro.title}
        subtitle={carportsIntro.subtitle}
      >
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="space-y-px bg-white/10">
            {carports.map((carport, index) => (
              <article
                key={carport.slug}
                className="grid gap-10 bg-black p-8 lg:grid-cols-[1fr_1.2fr] lg:items-center lg:p-12"
              >
                <div className="order-1 border border-white/10 bg-surface p-6 lg:order-none">
      ...
      <CtaSection
        title="Nicht sicher, welche Baureihe passt?"
        body="Nennen Sie uns Stellplatzanzahl, Fahrzeugtypen und die Ausrichtung der Parkgasse. Wir schlagen die passende Baureihe vor und rechnen den Ertrag durch."
